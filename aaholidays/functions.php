...
function enqueue_parent_styles() {
    ...
    // Flickity stylings from child-theme
    wp_enqueue_style('flickity-css', get_stylesheet_directory_uri() . '/flickity/flickity.min.css');
    wp_enqueue_style('flickity-fullscreen', get_stylesheet_directory_uri() . '/flickity/fullscreen.css');
...
function alh_add_vc_element_icon() {
    ?>
    <style>
        .vc-element-icon.icon-alh,
        .vc_element-icon.icon-alh {
            background-image: url('<?php echo get_stylesheet_directory_uri() . '/images/logo80x80.png' ?>') !important;

                        ...
                        if (!empty($content)) {
                            ...
                            <div class="st-overview">
                                ...
                                <div class="st-description"
                                     data-toggle-section="st-description" <?php if ($count >= 200) {
                                            ...
                                            <ul class="exclude">
                                                ...
                                                if (!empty($ex_arr)) {
                                                    foreach ($ex_arr as $k => $v) {
                                                        ...
                                                        echo '<li>' . TravelHelper::getNewIcon('remove', '#FA5636', '18px', '18px', false) . balanceTags($v) . '</li>';
                                                    }
                                                }
                                                ?>
                                            </ul>
                        ...
                        if (!empty($tour_faq)) {
                            ...
                            <div class="st-faq ">
                                ...
                                foreach ($tour_faq as $k => $v) { ?>
                                    <div class="item active <?php /*echo ($i == 0) ? 'active' : ''; */?>">
                                        <div class="header">
                                    ...
                                    if($booking_type == 'instant_enquire'){
                                        ...
                                        if($booking_type == 'enquire'){
                                            ...
                                            <div class="form-book-wrapper relative">
                                                ...
                                                <h4 class="title-enquiry-form"><?php echo __('Inquiry', 'traveler'); ?></h4>
                                                <?php echo st()->load_template( 'email/email_single_service' ); ?>
                                                <input style="display:none;" type="submit" class="btn btn-default btn-send-message" data-id="<?php echo get_the_ID();?>" name="st_send_message" value="<?php echo __('Send message', 'traveler');?>">
                                            </div>
                                            <?php

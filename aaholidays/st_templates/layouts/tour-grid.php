...
<div class="<?php echo esc_attr($class); ?>">
    <div class="service-border">
        ...
        <div class="service-review plr15">
            ...
            ?>
            <span class="review">
                <?php //echo esc_html($count_review) . ' ' . _n(esc_html__('Review', ST_TEXTDOMAIN),esc_html__('Reviews', ST_TEXTDOMAIN),$count_review); ?>
                <?php comments_number(__('0 reviews', ST_TEXTDOMAIN), __('1 Review', ST_TEXTDOMAIN), __('% Reviews', ST_TEXTDOMAIN)); ?>
            </span>
        </div>

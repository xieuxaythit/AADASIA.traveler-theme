        ...
        if (st_check_service_available('st_tours')) {
            ...
            if ($query->have_posts()) {
                if ($style == 'style1') {
                    ...
                    echo '<div class="search-result-page st-tours service-slider-2 service-slider-wrapper"><div class="st-hotel-result"><div class="owl-carousel list-service-' . esc_attr($style) . '">';
                    while ($query->have_posts()):
                        $query->the_post();
                        echo st()->load_template('layouts/modern/tour/elements/loop/grid', '', array('slider' => true));
                    endwhile;
                    ...
                    echo '<div class="search-result-page st-tours service-slider-wrapper"><div class="st-hotel-result"><div class="list-service-' . esc_attr($style) . '">';
                    while ($query->have_posts()):
                        $query->the_post();
                        echo st()->load_template('layouts/modern/tour/elements/loop/grid', '', array('slider' => false,'col'=> '3'));
                    endwhile;
                    echo '</div></div></div>';
                }
            }
